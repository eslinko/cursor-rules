...
|------|----------|------------|
| `builder_project` | `gateway` \| `gpt` \| `identity` \| `spa` \| `scripts` \| `capybara` \| `landing` \| `zeya888` | Ключ из `profiles.yaml` |
